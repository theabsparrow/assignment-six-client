...
const BlogComponent = ({
  ...
  return (
    <section className="px-4 md:px-8 lg:px-16 py-6 md:py-10 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div className="flex gap-3">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition font-medium shadow-sm border cursor-pointer
          ${
            blogStatus === "archived"
        ...
        `}
          ...
          ${
            blogStatus === "published"
              ...
              : "bg-white text-gray-600 border-gray-300 hover:bg-primary/10"
          }
        `}
          >
            <FileText size={18} />
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="flex-1 md:max-w-sm border border-primary focus:ring-2 focus:ring-primary/50 dark:bg-gray-800 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 px-4 py-2 rounded-l-md outline-none transition"
          />
          <button className="bg-[#00823e] hover:bg-green-800 dark:bg-blue-400 dark:hover:bg-blue-500 duration-500 text-white font-semibold py-2 px-4 rounded-r-lg shadow-md transition cursor-pointer border border-primary">
            Search
          </button>
        </form>
