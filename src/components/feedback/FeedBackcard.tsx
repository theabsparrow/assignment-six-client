...
const FeedBackcard = ({ feedbackData }: FeedbackCardProps) => {
  const date = convertDate(new Date(feedbackData?.createdAt));
  return (
    <div className="w-full max-w-lg mx-auto px-2 md:px-6 py-3 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-300 space-y-2">
