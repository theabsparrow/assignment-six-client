const LoadingKitchenProfile = () => {
  return (
    <section className="bg-gradient-to-br from-green-50 to-yellow-50 dark:bg-gray-600 shadow-lg rounded-2xl overflow-hidden max-w-4xl mx-auto px-4 md:px-10 py-4 space-y-4 md:space-y-10 animate-pulse">
      <div className="flex flex-col md:flex-row items-center gap-4">
        <div className="w-72 h-72 rounded-full">
          <div className="rounded-full bg-gray-300 dark:bg-gray-700 border-4 border-white shadow-md w-72 h-72" />
        </div>
...
export default LoadingKitchenProfile;
