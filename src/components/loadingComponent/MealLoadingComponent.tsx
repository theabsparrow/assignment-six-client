const MealLoadingComponent = () => {
  return (
    <section className="space-y-10 mx-auto w-full md:w-[60vw] bg-gradient-to-r from-indigo-100 to-blue-100 dark:from-indigo-900 dark:to-blue-900 px-4 md:px-16 py-6 shadow-xl rounded-xl animate-pulse">
...
export default MealLoadingComponent;
