      ...
      {isEditing && (
        <div>
          <button
            ...
            className="px-2 py-1 text-white text-sm  font-semibold bg-primary hover:text-secondary duration-500 border border-secondary transition rounded-lg shadow-md focus:outline-none cursor-pointer"
          >
            Verify Email
          </button>
        </div>
