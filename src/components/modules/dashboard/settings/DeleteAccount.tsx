              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mb-4">
                ...
                <div className="flex justify-end gap-3">
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium rounded-md bg-gray-200 text-gray-800 hover:bg-gray-300 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-2 text-sm font-medium rounded-md bg-red-600 text-white hover:bg-red-700 flex items-center gap-2 cursor-pointer"
                  >
                    <FaTrashAlt />
                    Delete
                  </button>
