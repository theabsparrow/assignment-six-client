...
const FoodCategoryBanner = () => {
  return (
    ...
    >
      ...
      <div className="absolute z-20 w-[95%] lg:w-[90%] h-[80%] lg:h-[95%] bg-[#1c1c1c] top-[20%] lg:top-[2%] left-[3%] lg:left-[5%] bg-[url('/category.webp')] bg-cover bg-center bg-no-repeat px-3 py-3 lg:px-10 lg:py-4">
